...
export function DeleteTrackModal({ track, onClose, onConfirm }: DeleteTrackModalProps) {
  ...
  return (
    <Modal isOpen={!!track} onClose={onClose} title="Delete Track?">
      <div className="space-y-6">
        <div className="text-zinc-700 dark:text-zinc-300">
          <p>Are you absolutely sure you want to permanently delete <strong className="text-zinc-900 dark:text-white">{track.topic}</strong>?</p>
        ...
        <div className="pt-2 flex justify-end space-x-3">
          ...
          >
            {countdown > 0 ? `Delete in ${countdown}s` : 'Delete Track'}
          </button>
        </div>
      </div>
    </Modal>
